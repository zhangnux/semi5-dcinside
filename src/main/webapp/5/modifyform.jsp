...
%>
			<!-- 
			 ...
			 -->
			<form class="border p-3 bg-light" method="post" action="modify.jsp?no=<%=boardDetail.getNo()%>">
				<div class="mb-3">
					<label class="form-label" for="board-title">제목</label>
					<input type="text" class="form-control" name="title" id="board-title" value=<%=boardDetail.getTitle() %>>
				</div>
				<div class="mb-3">
					<label class="form-label" for="board-content">내용</label>
					<textarea rows="6" class="form-control" name="content"><%=boardDetail.getContent() %></textarea>
				</div>
				<div class="mb-3 text-end">
					<a href="list.jsp?categoryNo=5" class="btn btn-secondary">취소</a>
