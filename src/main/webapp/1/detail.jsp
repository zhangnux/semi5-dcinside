...
<%
	...
	%>
							...
							%>				
								...
								<a href="http://localhost/semi5/1/delete.jsp?boardNo=<%=board.getNo()%>&writerNo=<%=comments.getWriter().getNo()%>&commentNo=<%=comments.getNo()%>&order=<%=comments.getOrder()%>&groupNo=<%=comments.getGroup()%>">
...
%>
					<div class="row my-3" id="form-<%=comments.getNo()%>" style="display: none;">
						<div class="col">
							...
							<form method="get" action="http://localhost/semi5/1/reply.jsp" class="border bg-light p-2">
...
%>
	...
	<div class="row mb-3 px-3 py-2">
		<div class="col">
			<form method="post" action="http://localhost/semi5/1/comment.jsp" class="border bg-light p-2">
				<input type="hidden" name="boardNo" value="<%=board.getNo()%>" />
				<div class="row g-3">
					<div class="col-10">
